...
1. `dataset_preview.png`: Tabular preview of the dataset.
2. `class_distribution.png`: Visualizes target distribution to verify class balance.
3. `correlation_heatmap.png`: Correlation matrix of continuous features.
4. `decision_tree.png`: High-resolution graphic of the pruned decision tree.
5. `confusion_matrix_dt.png` / `confusion_matrix_rf.png`: Confusion matrices.
6. `feature_importance.png`: Relative feature importances for both models.
7. `model_comparison.png`: Comparison of Accuracy, Precision, Recall, F1, and AUC.
8. `cross_validation_scores.png`: Boxplot showing the distribution of CV accuracies.
